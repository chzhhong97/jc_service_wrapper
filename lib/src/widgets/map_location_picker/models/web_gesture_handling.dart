import 'package:google_maps_flutter/google_maps_flutter.dart' as gm show WebGestureHandling;
...
enum WebGestureHandling {
  ...
  gm.WebGestureHandling toGoogle(){
    return gm.WebGestureHandling.values.firstWhere((e) => e.name == name, orElse: () => gm.WebGestureHandling.auto);
  }
}