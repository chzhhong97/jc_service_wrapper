import 'package:google_maps_flutter/google_maps_flutter.dart' as gm show WebCameraControlPosition;
enum WebCameraControlPosition {
  ...
  gm.WebCameraControlPosition? toGoogle(){
    for(var cp in gm.WebCameraControlPosition.values){
